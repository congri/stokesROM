classdef StokesData < handle
    ...
    properties
        ...
        meshSize = 256
        numberParams = [7.2, 0.6]   %[min, max] pos. number of circ. exclusions
        numberDist = 'logn';
        margins = [0.002, 0.002, 0.002, 0.002]    %[l., u.] margin for imp. phase
        r_params = [-5.53, .3]    %[lo., up.] bound on random blob radius
        coordDist = 'gauss_randmu'
        coordDist_mu = 'rand'   %only for gauss
...
%                 end
                ...
                dMat{n} = [dMat{n}, phi(:)];
                if n == 1
                    dlmwrite('./data/features', 'linPath08',...
                        'delimiter', '', '-append');
                end
                %log
                dMat{n} = [dMat{n}, log(phi(:) + delta_log)];
                ...
                dMat{n} = [dMat{n}, phi(:)];
                if n == 1
                    dlmwrite('./data/features', 'linPath04',...
                        'delimiter', '', '-append');
                end
                %log
                dMat{n} = [dMat{n}, log(phi(:) + delta_log)];
                ...
                dMat{n} = [dMat{n}, phi(:)];
                if n == 1
                    dlmwrite('./data/features', 'linPath01',...
                        'delimiter', '', '-append');
                end
                %log
                dMat{n} = [dMat{n}, log(phi(:) + delta_log)];
                ...
                dMat{n} = [dMat{n}, phi(:)];
                if n == 1
                    dlmwrite('./data/features', 'linPath005',...
                        'delimiter', '', '-append');
                end
                %log
                dMat{n} = [dMat{n}, log(phi(:) + delta_log)];
                ...
                dMat{n} = [dMat{n}, phi(:)];
                if n == 1
                    dlmwrite('./data/features', 'chordLengthDens01',...
                        'delimiter', '', '-append');
                end
                %log
                dMat{n} = [dMat{n}, log(phi(:) + delta_log)];
...
%                 end
                ...
                dMat{n} = [dMat{n}, e_v(:)];
                if n == 1
                    dlmwrite('./data/features', 'e_v02',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, h_v(:)];
                if n == 1
                    dlmwrite('./data/features', 'h_v02',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, poreSizeDens(:)];
                if n == 1
                    dlmwrite('./data/features', 'poreSizeProbDens02',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, cumPoreSizeDens(:)];
                if n == 1
                    dlmwrite('./data/features', 'cumPoreSizeProbDens02',...
                        'delimiter', '', '-append');
                end
                ...
                if n == 1
                    dlmwrite('./data/features', 'log_e_v02',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_h_v02',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_poreSizeProbDens02',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_cumPoreSizeProbDens02',...
                        'delimiter', '', '-append');
                end
                ...
                [e_p, h_p] = particleNearestSurfaceExclusion(...
                    mData{n}.diskCenters, mData{n}.diskRadii, gridRF, .02, .01);
                dMat{n} = [dMat{n}, e_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'e_p0201',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, h_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'h_p0201',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, log(e_p(:) + delta_log),...
                    log(h_p(:)+delta_log)];
                if n == 1
                    dlmwrite('./data/features', 'log_e_p0201',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_h_p0201',...
                        'delimiter', '', '-append');
                end
                
                [e_p, h_p] = particleNearestSurfaceExclusion(...
                    mData{n}.diskCenters, mData{n}.diskRadii, gridRF, .01,.005);
                dMat{n} = [dMat{n}, e_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'e_p01005',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, h_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'h_p01005',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, log(e_p(:) + delta_log),...
                    log(h_p(:)+delta_log)];
                if n == 1
                    dlmwrite('./data/features', 'log_e_p01005',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_h_p01005',...
                        'delimiter', '', '-append');
                end
                
                [e_p, h_p] = particleNearestSurfaceExclusion(...
                    mData{n}.diskCenters, mData{n}.diskRadii,gridRF,.005,.0025);
                dMat{n} = [dMat{n}, e_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'e_p0050025',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, h_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'h_p0050025',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, log(e_p(:) + delta_log),...
                    log(h_p(:)+delta_log)];
                if n == 1
                    dlmwrite('./data/features', 'log_e_p0050025',...
                        'delimiter', '', '-append');
                    dlmwrite('./data/features', 'log_h_p0050025',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, e_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'e_p002500125',...
                        'delimiter', '', '-append');
                end
                dMat{n} = [dMat{n}, h_p(:)];
                if n == 1
                    dlmwrite('./data/features', 'h_p002500125',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, sqrt(phi(:))];
                if n == 1
                    dlmwrite('./data/features', 'sqrt_2pointCorr04',...
                        'delimiter', '', '-append');
                end
                ...
                dMat{n} = [dMat{n}, sqrt(phi(:))];
                if n == 1
                    dlmwrite('./data/features', 'sqrt_2pointCorr02',...
                        'delimiter', '', '-append');
                end
